...
const {
  isDark, loading, openSettings, useSideMargin, telegramApp, isTelegram
} = useGlobalState()
...
const isContactExperience = computed(() => (
  route.meta.contactLayout === true || openSettings.value.mode === 'contact'
));
const showSideMargin = computed(() => !isContactExperience.value && !isMobile.value && useSideMargin.value);
const showAd = computed(() => !isContactExperience.value && !isMobile.value && adClient && adSlot);
    ...
    <n-spin description="loading..." :show="loading">
      <n-notification-provider container-style="margin-top: 60px;">
        <n-message-provider container-style="margin-top: 20px;">
          <div v-if="isContactExperience" class="contact-app">
